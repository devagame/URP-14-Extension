...
namespace UnityGameFramework.Runtime
{
    public sealed partial class DebuggerComponent : DebuggerController
    {
        private sealed class SettingsWindow : ScrollableDebuggerWindowBase
        {
            ...
            {
                m_DebuggerComponent = GameObject.FindObjectOfType<DebuggerComponent>();//  GameEntry.GetComponent<DebuggerComponent>();
                ...
                m_SettingComponent = GameObject.FindObjectOfType<SettingComponent>();//GameEntry.GetComponent<SettingComponent>();
