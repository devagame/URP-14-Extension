           ...
           // private ResourceComponent m_ResourceComponent = null;
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
...
#endif
                    DrawItem("Game Framework Version","TODO"/*Version.GameFrameworkVersion*/);
                    DrawItem("Game Version", Utility.Text.Format("{0} ({1})", 1,2/*Version.GameVersion, Version.InternalGameVersion*/));
                    ...
                    DrawItem("Resource Version","TODO");
