    ...
    public static partial class Utility
    {
        ...
        public static partial class Compression
        {
            ...
            public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
            {
                ...
                {
                    throw new ArgumentException("Compressed helper is invalid.");
                }
                ...
                {
                    throw new ArgumentException("Compressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new ArgumentException(Text.Format("Can not compress with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
            {
                ...
                {
                    throw new ArgumentException("Decompressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new ArgumentException(Text.Format("Can not decompress with exception '{0}'.", exception), exception);
                }
            }
