...
public class ScalableBlurConfigEditor : UnityEditor.Editor
{
    ...
    readonly GUIContent sourceTypeLabel = new GUIContent(
        "SourceRenderType",
        "UIStyle. Source Render For Canvase UI Image\nBackground. Source Render For Background SpriteRenderer"
    );
    ...
    {
        config.SourceRenderType = (SourceRenderType) EditorGUILayout.EnumPopup(sourceTypeLabel,config.SourceRenderType);
