...
namespace XPostProcessing
{
    ...
    public class DepthFog2 : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/DepthFog2";
        }
    }
    ...
    {
        public const string PROFILER_TAG = "Depth Fog2";
       // public override string ShaderName => "Hidden/PostProcessing/DepthFog2";
        ...
        public override void Render(CommandBuffer cmd, RenderTargetIdentifier source, RenderTargetIdentifier target, ref RenderingData renderingData)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderContants.sunScattingID, settings.sunScatting.value);
            m_BlitMaterial.SetVector(ShaderContants.warmColorID, settings.warmColor.value);
            m_BlitMaterial.SetVector(ShaderContants.coldColorID, settings.coldColor.value);
