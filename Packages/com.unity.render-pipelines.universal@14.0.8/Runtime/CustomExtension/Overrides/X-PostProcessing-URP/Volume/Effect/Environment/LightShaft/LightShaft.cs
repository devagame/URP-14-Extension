...
namespace XPostProcessing
{
    ...
    public class LightShaft : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/Environment/LightShift";
        }
    }
    ...
    {
        public const string PROFILER_TAG = "LightShift";
       // public override string ShaderName => "Hidden/PostProcessing/Environment/LightShift";
            ...
            ref RenderingData renderingData)
        {
            ...
            m_BlitMaterial.SetVector(ShaderIDs.BloomTintAndThreshold, new Vector4(bloomTint.x, bloomTint.y, bloomTint.z, settings.Threshold.value));
            m_BlitMaterial.SetVector(ShaderIDs.LightShaftParameters, new Vector4(settings.OcclusionDepthRange.value, settings.BloomIntensity.value, sunScreenPos.x / camera.pixelWidth, sunScreenPos.y / camera.pixelHeight));
            cmd.Blit(source, ShaderIDs.LightShaftTempId, m_BlitMaterial, 0);
            ...
            cmd.Blit(ShaderIDs.LightShaftTempId, ShaderIDs.TempBlurBuffer1, m_BlitMaterial, 1);
            //2

            m_BlitMaterial.SetInt(ShaderIDs.SampleDistance, sampleDistance * 2);
            cmd.Blit(ShaderIDs.TempBlurBuffer1, ShaderIDs.TempBlurBuffer2, m_BlitMaterial, 1);
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.Attenuation, settings.Attenuation.value);
