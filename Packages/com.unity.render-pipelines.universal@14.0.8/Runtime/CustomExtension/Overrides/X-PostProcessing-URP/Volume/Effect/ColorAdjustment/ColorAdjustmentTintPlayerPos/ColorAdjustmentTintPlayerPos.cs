...
namespace XPostProcessing
{
    ...
    public class ColorAdjustmentTintPlayerPos : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/ColorAdjustment/TintPlayerPos";
        }
    }

    public class ColorAdjustmentTintPlayerPosRenderer : VolumeRenderer<ColorAdjustmentTintPlayerPos>
    {
        public const string PROFILER_TAG = "ColorAdjustmentTintPlayerPos";
            ...
            ref RenderingData renderingData)
        {
            ...
            m_BlitMaterial.SetFloat(ShaderIDs.range, ColorAdjustmentTintPlayerPos.range);
