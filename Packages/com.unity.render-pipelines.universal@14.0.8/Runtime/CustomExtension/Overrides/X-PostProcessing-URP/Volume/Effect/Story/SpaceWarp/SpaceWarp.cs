...
namespace XPostProcessing
{
    ...
    public class SpaceWarp : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/SpaceWarp";
        }
    }
    ...
    public class SpaceWarpRenderer : VolumeRenderer<SpaceWarp>
    {
        ...
        public const string PROFILER_TAG = "SPACEWARP";
        ...
        {
            m_BlitMaterial.SetFloat(ShaderIDs.spaceWarpIntensityID, settings.spaceWarpIntensity.value);
