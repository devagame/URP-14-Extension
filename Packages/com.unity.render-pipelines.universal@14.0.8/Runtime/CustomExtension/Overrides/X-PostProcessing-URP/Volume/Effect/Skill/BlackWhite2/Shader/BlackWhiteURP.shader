...
Shader "Hidden/PostProcessing/Skill/BlackWhite3"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Float6("中心位置U", Range( -0.5 , 0.5)) = 0
		...
		[ASEEnd]_Float13("V振幅测试", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 temp_cast_1 = (jizuobiaowenli423).xxx;
...
/*ASEBEGIN
Version=18912
334;362;1699;859;2951.144;3102.731;3.7652;True;True
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;150;-3417.97,-1663.541;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;291;2;423;0
ASEEND*/
//CHKSM=AC911D5C0F9E25C91FAA517C70637BBFA411F538