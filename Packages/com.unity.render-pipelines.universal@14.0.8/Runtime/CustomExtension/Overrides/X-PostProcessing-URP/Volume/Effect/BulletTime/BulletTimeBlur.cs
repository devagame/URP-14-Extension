...
namespace XPostProcessing
{
    ...
    public class BulletTimeBlur : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/BulletTimeBlur22";
        }
    ...
    {
        public const string PROFILER_TAG = "Bullet Time Blur";
        ...
        {
            m_BlitMaterial.SetVector(ShaderContants.bulletTimeBlurCenterPointID, settings.bulletBlurCenterPoint.value);
            m_BlitMaterial.SetFloat(ShaderContants.bulletTimeBlurControlID, settings.bulletBlurControl.value * settings.bulletBlurLength.value);
            m_BlitMaterial.SetFloat(ShaderContants.bulletTimeUnBlurRadiusID, settings.bulletUnBlurRadius.value);
