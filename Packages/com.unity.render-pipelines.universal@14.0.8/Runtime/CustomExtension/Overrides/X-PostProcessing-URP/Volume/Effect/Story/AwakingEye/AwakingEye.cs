...
namespace XPostProcessing
{
    ...
    public class AwakingEye : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/AwakingEye";
        }
    }

    public class AwakingEyeRenderer : VolumeRenderer<AwakingEye>
    {
        public const string PROFILER_TAG = "AWAKING_EYE";
        ...
        {
            m_BlitMaterial.SetFloat(ShaderIDs.awakingEyeOpenValueID, settings.awakingEyeOpenValue.value);
            m_BlitMaterial.SetFloat(ShaderIDs.awakingEyeOpenLengthID, settings.awakingEyeOpenLength.value);
